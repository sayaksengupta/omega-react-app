...
function Profile({ user, setSelectedNav }) {
  ...
  const getUser = async () => {
    try {
      const response = await axios.get(
        `http://localhost:8080/${Type}/get-${Type}`,
        {
          headers: { token: token },
        }
      );
      ...
      // Update only the keys that exist in editUser
  ...
  const Edit = async (e) => {
    e.preventDefault();
    await axios
      .put(`http://localhost:8080/${Type}/update-${Type}`, editUser, {
        headers: { token: token },
      })
      .then((res) => {
    ...
    <>
      ...
      <div className="dashContainer">
        ...
        <div className="createPackageForm">
          <form
            action="http://omega.5gsoftware.net/updateProfile"
          ...
          >
            <div className="inputbg">
              ...
              <input
                ...
                defaultValue="Debasish Bhattcharyya"
                readOnly={toggleEdit}
              />
            </div>
            <p
            ...
            <div style={{ marginBottom: "25px" }}>
              <div className="inputbg" style={{ marginBottom: "4px" }}>
                <label htmlFor>License Number: </label>
                <input
                  type="text"
                  placeholder="Stock Advisor License Number"
                  id="license"
                ...
                <span>
                  <Link
                    ...
                    onClick={() => setSelectedNav("verify")}
                  >
                    Re verify
                  </Link>
                </span>
              </div>
              <div className="spanWarning-full2">
            ...
            <input type="hidden" name="token" defaultValue="gwfZzRWnPC" />
            <div className="text-center">
              <button
                className="save_btn portfolio-link"
                type="submit"
                onClick={Edit}
              >
                {" "}
